-- The Core database is intentionally reset before this migration is applied.
-- Recreate its tables with integer primary and foreign keys.
DROP TABLE IF EXISTS "ships";
DROP TABLE IF EXISTS "fleets";
DROP TABLE IF EXISTS "companies";
DROP TYPE IF EXISTS "ShipState";
...
ALTER TABLE "fleets" ADD CONSTRAINT "fleets_companyId_fkey"
  FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "ships" ADD CONSTRAINT "ships_companyId_fkey"
  FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "ships" ADD CONSTRAINT "ships_fleetId_fkey"
